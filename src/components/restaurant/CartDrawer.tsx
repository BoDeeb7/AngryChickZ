...
export function CartDrawer({ isOpen, onClose }: { isOpen: boolean, onClose: () => void }) {
  ...
  const handleCheckout = () => {
    if (!details.customerName || !details.phoneNumber || !details.address) return;
    ...
    // Optional: Reset cart and close after redirection
    clearCart();
          ...
          {cart.length === 0 ? (
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6 pt-4">
                ...
                <div className="space-y-6 pt-6 border-t border-amber-500/5">
                  <h3 className="text-[10px] font-black uppercase tracking-[0.2em] text-foreground/40">Checkout Details</h3>
                  ...
                  <div className="space-y-2">
                    <Label className="text-[10px] font-black text-foreground/40 uppercase tracking-widest flex items-center gap-2">
                      <MapPin className="h-3 w-3" /> Delivery Address / Location
                    </Label>
                    <Textarea 
